...
export default function Shop() {
  ...
  useSeo({
    ...
    description: 'De volledige collectie van Atelier Nomàd: 31 unieke vintage Marokkaanse vloerpoufs, plus acht handgeweven wollen kussens.',
  })
    ...
    <>
      <section className="page-hero container">
        ...
        <p className="lead measure reveal" data-delay="2">
          {products.length} stukken, in één keer geselecteerd in Marokko: eenendertig vintage

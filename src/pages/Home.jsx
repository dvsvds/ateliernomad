...
export default function Home() {
  ...
  useSeo({
    ...
    description: 'Atelier Nomad — unieke vintage Marokkaanse vloerpoufs van gerecyclede Berberkleden, plus handgemaakt meubilair van laurierhout en doumtouw. Elk stuk bestaat maar één keer.',
  })

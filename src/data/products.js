...
export const products = [
  p('pouf-haze', 'Vloerpouf — Haze', 'modern', 245, 'Bestseller',
  ...
  p('pouf-poppy', 'Vloerpouf — Poppy', 'modern', 245, null,
  ...
  p('pouf-heather', 'Vloerpouf — Heather', 'authentiek', 245, null,
  ...
  p('pouf-saffron', 'Vloerpouf — Saffron', 'authentiek', 245, null,
  ...
  p('pouf-clay', 'Vloerpouf — Clay', 'geweven', 285, null,
  ...
  p('pouf-drift', 'Vloerpouf — Drift', 'authentiek', 245, null,
  ...
  p('pouf-indigo', 'Vloerpouf — Indigo', 'authentiek', 245, null,
  ...
  p('pouf-peach', 'Vloerpouf — Peach', 'authentiek', 245, null,
  ...
  p('pouf-chalk', 'Vloerpouf — Chalk', 'modern', 195, null,
  ...
  p('pouf-tide', 'Vloerpouf — Tide', 'modern', 245, null,
  ...
  p('pouf-blush', 'Vloerpouf — Blush', 'authentiek', 285, 'Zeldzaam',
  ...
  p('pouf-cinnamon', 'Vloerpouf — Cinnamon', 'modern', 245, 'Bestseller',
  ...
  p('pouf-dune', 'Vloerpouf — Dune', 'geweven', 285, null,
  ...
  p('pouf-rust', 'Vloerpouf — Rust', 'geweven', 285, null,
  ...
  p('pouf-pebble', 'Vloerpouf — Pebble', 'authentiek', 245, null,
  ...
  p('pouf-solstice', 'Vloerpouf — Solstice', 'modern', 245, null,
  ...
  p('pouf-shoal', 'Vloerpouf — Shoal', 'modern', 245, null,
  ...
  p('pouf-ember', 'Vloerpouf — Ember', 'modern', 245, null,
  ...
  p('pouf-meadow', 'Vloerpouf — Meadow', 'geweven', 285, null,
  ...
  p('pouf-quill', 'Vloerpouf — Quill', 'geweven', 195, null,
  ...
  p('pouf-thistle', 'Vloerpouf — Thistle', 'geweven', 285, null,
  ...
  p('pouf-marigold', 'Vloerpouf — Marigold', 'geweven', 285, null,
  ...
  p('pouf-signal', 'Vloerpouf — Signal', 'modern', 285, 'Zeldzaam',
  ...
  p('pouf-basalt', 'Vloerpouf — Basalt', 'modern', 285, null,
  ...
  p('pouf-ash', 'Vloerpouf — Ash', 'authentiek', 245, null,
  ...
  p('pouf-mist', 'Vloerpouf — Mist', 'modern', 245, null,
  ...
  p('pouf-sorrel', 'Vloerpouf — Sorrel', 'geweven', 285, 'Zeldzaam',
  ...
  p('pouf-coral', 'Vloerpouf — Coral', 'geweven', 285, null,
  ...
  p('pouf-foxglove', 'Vloerpouf — Foxglove', 'geweven', 285, 'Zeldzaam',
  ...
  p('pouf-apricot', 'Vloerpouf — Apricot', 'geweven', 285, null,
  ...
  p('pouf-garnet', 'Vloerpouf — Garnet', 'geweven', 285, null,
  ...
  p('pouf-bloom', 'Vloerpouf — Bloom', 'authentiek', 245, null,
  ...
  p('pouf-kapsa', 'Vloerpouf — Kapsa', 'authentiek', 245, null,

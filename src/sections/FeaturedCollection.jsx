    ...
    <section className="section">
      <div className="container">
        <div className="section-head" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: '1rem', maxWidth: 'none' }}>
          <div>
            <span className="eyebrow reveal">Uitgelicht</span>
            <h2 className="h2 reveal" data-delay="1">Geliefde stukken</h2>
          </div>
          <Link to="/shop" className="link-underline reveal" data-delay="2">Bekijk alles</Link>
        </div>
